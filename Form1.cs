...
namespace XO_Game_Final
{
    public partial class Form1 : Form
    {
        ...
        void EndGame()
        {
            ...
            switch (GameStatus.Winner)
            {
                ...
                case enWinner.Player1:
                       ...
                       lblWinner.BackColor = Color.Green;
                        break;
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(YellowPen, 400, 300, 1050, 300);
            e.Graphics.DrawLine(YellowPen, 400, 460, 1050, 460);

            //draw Vertical lines
            e.Graphics.DrawLine(YellowPen, 610, 140, 610, 620);
            e.Graphics.DrawLine(YellowPen, 840, 140, 840, 620);
